              ...
              <div className="row margin-bottom">
                <div className="col-lg-4">
                  <div className="heading heading--primary">
                    <span className="heading__pre-title color--green">
                      What we Do
                    </span>
                    <h2 className="heading__title no-margin-bottom">
                      <span>Helpo</span> <span>Causes</span>
                    </h2>
                  </div>
                </div>
                <div className="col-lg-8">
                  <p className="causes__heading-text">
                    ...
                    rostrata. Midshipman dartfish Modoc sucker, yellowtail
                    kingfish. Canthigaster rostrata. Midshipman dartfish Modoc
                    sucker, yellowtail kingfish basslet.{" "}
                  </p>
                </div>
              </div>
                          ...
                          !this.props.isAuthenticated ? (
                            ...
                            <div className="causes-item__action">
                              ...
                              this.props.UserData.isAuthenticated ? (
                                <a
                                  onClick={() =>
                                    this.handleOnClickDonation(item)
                                  }
                          ...
                          <div className="causes-item__lower">
                            ...
                            <div className="causes-item__details-holder">
                              ...
                              <div className="causes-item__details-item text-right">
                                <span>Pledged: </span>
                                <span>{toEther(item.c_raised)} ETH</span>
                              </div>
                            </div>
                          </div>
                        </div>
...
const mapStateToProps = (state) => ({ UserData: state.AuthData });
